...
class CortexAgent(LangChainAgent):
    db: Any  # Change the type hint to Any
    system_message: str
...
class Agent(BaseModel):
    ...
    def _init_agent(self):
        from toolkit import AgentToolkit  # Move this import here to avoid circular imports
        toolkit = AgentToolkit(db=self.db, con=self.con)
        tools = toolkit.get_tools()
        ...
        cortex_agent = CortexAgent(system_message=system_message, db=self.db)
